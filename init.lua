...
vim.keymap.set('n', '<C-j>', ':cnext<cr>', { desc = 'Go to next occurrence in quickfix list' })
vim.keymap.set('n', '<C-k>', ':cprev<cr>', { desc = 'Go to previous occurrence in quickfix list' })
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          --  AND THEN REMEMBER TO USE :wa TO SAVE EVERY CHANGED FILE
